jQuery(document).ready(function($) {
    ...
    var sectionsAvailable = $('.cd-section'),
        ...
        processNav = verticalNav.find('a.cd-process'),
        planningNav = verticalNav.find('a.cd-planning'),
        investingNav = verticalNav.find('a.cd-investing'),
        podcastNav = verticalNav.find('a.cd-podcast'),
        newsNav = verticalNav.find('a.cd-news'),
        aboutNav = verticalNav.find('a.cd-about');
